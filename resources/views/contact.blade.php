...
@section('content')
    ...
    <div class="absolute inset-0 bg-yellow-100/80 flex flex-col items-center justify-center text-center px-4">
      ...
      <form action="#" method="POST" class="w-full max-w-xl space-y-4">
        ...
        <div class="flex flex-col md:flex-row gap-4">
          <input type="text" name="matric" placeholder="Matric No :" class="w-full md:w-1/2 px-4 py-2 rounded-md border border-gray-300">
          <input type="email" name="email" placeholder="Email :" class="w-full md:w-1/2 px-4 py-2 rounded-md border border-gray-300">
        </div>
  ...
  <div class="bg-yellow-300 py-8 text-center">
    ...
    <div class="flex justify-center gap-6 flex-wrap">
      ...
      <a href="https://www.tiktok.com" target="_blank" class="flex flex-col items-center">
